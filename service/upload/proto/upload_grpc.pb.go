...
type UploadServiceClient interface {
	// 获取上传入口地址
	UploadEntry(ctx context.Context, in *ReqUploadEntry, opts ...grpc.CallOption) (*RespUploadEntry, error)
}
...
func (c *uploadServiceClient) UploadEntry(ctx context.Context, in *ReqUploadEntry, opts ...grpc.CallOption) (*RespUploadEntry, error) {
	out := new(RespUploadEntry)
	err := c.cc.Invoke(ctx, "/proto.UploadService/UploadEntry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUploadServiceServer) UploadEntry(context.Context, *ReqUploadEntry) (*RespUploadEntry, error) {
...
func _UploadService_UploadEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.UploadService/UploadEntry",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UploadServiceServer).UploadEntry(ctx, req.(*ReqUploadEntry))
	}
