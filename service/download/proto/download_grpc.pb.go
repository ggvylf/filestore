...
type DownloadServiceClient interface {
	// 获取下载入口地址
	DownloadEntry(ctx context.Context, in *ReqDownloadEntry, opts ...grpc.CallOption) (*RespDownloadEntry, error)
}
...
func (c *downloadServiceClient) DownloadEntry(ctx context.Context, in *ReqDownloadEntry, opts ...grpc.CallOption) (*RespDownloadEntry, error) {
	out := new(RespDownloadEntry)
	err := c.cc.Invoke(ctx, "/proto.DownloadService/DownloadEntry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDownloadServiceServer) DownloadEntry(context.Context, *ReqDownloadEntry) (*RespDownloadEntry, error) {
...
func _DownloadService_DownloadEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.DownloadService/DownloadEntry",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DownloadServiceServer).DownloadEntry(ctx, req.(*ReqDownloadEntry))
	}
