...
// 执行的所有router参考dbproxy/mapper/mapper.go
...
// OnFileUploadFinished : 新增/更新文件元信息到tbl_file
...
// OnUserFileUploadFinished : 新增/更新fm信息到tbl_user_file
